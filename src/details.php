...
class Details {
    ...
    public function setter($user_id) {
    ...
    public function detailsFunction(mysqli $con) {
        $result = mysqli_query($con, "SELECT * FROM users where id = $this->user_id");
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM orders WHERE customer_id = $this->user_id;");
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
								...
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM tickets WHERE poster_id = $this->user_id AND not deleted;");
									while($row = mysqli_fetch_array($sql)){
...
if (isset($_SESSION['user_id'])) {
    $Details->setter($_SESSION['user_id']);
}
else if ($Details->getter() == null) {
    $Details->setter(0);
}

$Details->detailsFunction($con);
?>
