...
include __DIR__ . '/includes/wallet.php';

class Index {
    public function indexFunction(mysqli $con, $user_id, $balance, $name, $role) {
...
$Index = new Index();
$Index->indexFunction($con, $user_id, $balance, $name, $role);
?>
